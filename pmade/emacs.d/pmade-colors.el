...
(defun color-theme-pmade ()
  ...
  (custom-set-faces
   ;; minimap
   '(minimap-active-region-background ((t (:background "#253b1f"))))
   ;; jabber.el
   '(jabber-activity-face ((t (:background "red" :foreground "yellow"))))
   '(jabber-activity-personal-face ((t (:background "deep sky blue" :foreground "white" :weight bold))))
   '(jabber-chat-prompt-foreign ((t (:foreground "tomato"))))
   '(jabber-chat-prompt-local ((t (:background "light sky blue" :foreground "black" :box (:line-width 1 :color "grey75" :style released-button)))))
   '(jabber-chat-text-local ((t (:background "khaki1" :foreground "black"))))
...
;;   '(font-lock-preprocessor-face ((t (:background "#202020" :bold t :box (:line-width 1 :style released-button)))))
   ...
   ;; lookup
   '(lookup-heading-1-face ((((class color) (background dark)) (:foreground "LightBlue" :inverse-video t :height 1.5))))
   '(lookup-referred-face ((((class color) (background dark)) (:foreground "orange red"))))
   '(lookup-reference-face ((((class color) (background dark)) (:foreground "OliveDrab1"))))
   '(ndeb-bold-face ((t (:foreground "khaki1" :weight bold))))
   '(ndeb-italic-face ((t (:foreground "dodger blue" :slant italic))))
   ...
   '(flymake-errline ((t (:background "dark red" :foreground "white"))))
   '(flymake-warnline ((t (:background "dim gray" :underline (:color "green" :style wave)))))
   ...
   '(flx-highlight-face ((t (:background "OrangeRed" :foreground "black"))))
   ...
   ;; Minibuffer
   '(minibuffer-noticeable-prompt ((t (:background "#670000" :foreground "#ffffff" :underline "#ff8e43"))))
   '(minibuffer-prompt ((t (:background "#670000" :foreground "#ffffff" :underline "#ff8e43"))))
   ...
   '(which-func ((t (:background "Yellow1" :foreground "darkred"))))
   ;; Bookmarks
   ...
   '(esense-tooltip-header-face ((((class color)) (:inherit bold :foreground "black"))))
   ;; pde
   '(perldoc-directory-face ((t (:inherit widget-button-face :foreground "light sky blue"))))
   '(woman-unknown ((t (:foreground "deep sky blue"))))

   ;; auto-complete
   '(ac-candidate-face ((t (:background "dark olive green" :foreground "white"))))
   '(ac-completion-face ((t (:background "DarkMagenta" :foreground "black" :underline t))))
   '(ac-selection-face ((t (:background "lime green" :foreground "black"))))

   ;; Remaining Junk
   '(completion-dynamic-face ((t (:inherit 'match))))

   '(highlight-changes ((t (:background "saddle brown"))))
   ...
   '(flyspell-incorrect ((t (:inherit error :underline (:color "error" :style wave)))))
   '(flyspell-duplicate ((t (:inherit warning :underline (:color "warning" :style wave)))))   
